...
class LivroController{
    ...
    public function telaCadastro(){
        require "View/LivroController.php";
    }
    ...
    public function cadastrar(){
        ...
        $livro->salvar();
        header('Location: /PB_PHP/prova_MVC/livro/telaCadastro');
        exit;
    }
    ...
    public function atualizar(){
        ...
        header('Location: /PB_PHP/prova_MVC/biblioteca/telaEditar?id='.($_GET['id']));
        exit;
    }

    public function excluir(){
        Livro::excluir($_GET['id']);
        header('Location: /PB_PHP/prova_MVC/biblioteca/Listar');
        exit;
    }
}
?>